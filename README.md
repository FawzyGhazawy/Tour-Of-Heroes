...
Summary:
1- You used ng generate to create a second HeroesComponent.
...
2-The Tour of Heroes application displays a list of heroes with a detail view.
The user can select a hero and see that hero's details.
You used *ngFor to display a list.
You used *ngIf to conditionally include or exclude a block of HTML.
You can toggle a CSS style class with a class binding.
Next:Create a feature component

3-You created a separate, reusable HeroDetailComponent.
You used a property binding to give the parent HeroesComponent control over the child HeroDetailComponent.
You used the @Input decorator to make the hero property available for binding by the external HeroesComponent.
Next:Add services

4-You refactored data access to the HeroService class.
...
6-You added the necessary dependencies to use HTTP in the application
